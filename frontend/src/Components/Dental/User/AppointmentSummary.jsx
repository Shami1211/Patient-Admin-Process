...
function AppointmentSummary() {
  ...
  const downloadPDF = () => {
    ...
    doc.text("Appointment Summary", 10, 10);
    doc.text(`Full Name: ${appointmentData.fullname}`, 10, 20);
    doc.text(`Appointment ID: ${appointmentData.appointmentID}`, 10, 30);
    doc.text(`Phone: ${appointmentData.phone}`, 10, 40);
    doc.text(`Email: ${appointmentData.email}`, 10, 50);
    doc.text(`Service: ${appointmentData.service}`, 10, 60);
    doc.text(`Clinic: ${appointmentData.clinic}`, 10, 70);
    doc.text(`Doctor: ${appointmentData.doctor}`, 10, 80);
    doc.text(`Date: ${appointmentData.date}`, 10, 90);
    doc.text(
